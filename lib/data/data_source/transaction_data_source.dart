...
abstract interface class TransactionDataSource {
  Future<void> createTransaction({required TransactionDetail transaction, required int assetId, required int userId});
  Future<List<TransactionDetail>> getTransactionList({required List<int> assetIdList, required int userId});
