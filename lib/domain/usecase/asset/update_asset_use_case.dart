...
class UpdateAssetUseCase {
  ...
  Future<void> execute({required Asset asset, required String userId, required String assetId}) async {
    await _assetRepository.updateAsset(asset: asset, userId: userId);
  }
}
