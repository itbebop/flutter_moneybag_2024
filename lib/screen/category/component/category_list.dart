...
class CategoryList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final inComeTransactionCategories = ref.read(categoryStateProvider.notifier).getTransactionCetegory(assetType);
    final expenseTransactionCategories = ref.read(categoryStateProvider.notifier).getTransactionCetegory(assetType);
