...
class CategoryState with _$CategoryState {
  const factory CategoryState({
    ...
    required CreateSubTransactionCategoryUseCase createSubTransactionCategoryUseCase,
    required GetTransactionCategoryUseCase getTransactionCategoryUseCase,
    required GetSubTransactionCategoryUseCase getSubTransactionCategoryUseCase,
